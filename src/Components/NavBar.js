...
const NavBar = function () {
  ...
  const trackRef = useCallback(function(e){
    if (e !== null){
    ...
    <div className="navBar">
      ...
      <div className="rightNav">
        <a
          ...
          style={final === "home" ? { animationName: " wiggle", animationDuration: "0.8s", animationIterationCount: "2", animationDelay: "0" } : null}
        >
          <LinkedInIcon />
        </a>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          style={final === "home" ? { animationName: " wiggle", animationDuration: "0.8s", animationIterationCount: "2", animationDelay: "0.1s" } : null}
        >
          <GitHubIcon />
        </a>
        <a
          ...
          rel="noopener noreferrer"
          style={final === "home" ? { animationName: " wiggle", animationDuration: "0.8s", animationIterationCount: "2", animationDelay: "0.2s" } : null}
        >
          <InstagramIcon />
        </a>
        <a
          ...
          rel="noopener noreferrer"
          style={final === "home" ? { animationName: " wiggle", animationDuration: "0.8s", animationIterationCount: "2", animationDelay: "0.3s" } : null}
        >
          <EmailIcon />
        </a>
      </div>
